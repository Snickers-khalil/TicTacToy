...
class GameLogic {
    ...
    public boolean winnerCheck(){
        ...
        if (isWinner){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(this.playerTurn.getContext());
            builder.setTitle("Winner");
            builder.setMessage(playerNames[player-1]+"Win This Game");

            // Set the image
            ImageView imageView = new ImageView(this.playerTurn.getContext());
